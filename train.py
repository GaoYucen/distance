...
parser.add_argument('--directed', action='store_true', default=False,
                    help='Use directed GNN (preserve one-way edge information, skip ToUndirected)')
parser.add_argument('--aux_loss_weight', type=float, default=0.0,
                    help='Weight for directional auxiliary loss (0=disabled, e.g., 0.1)')
...
if model_class == 'geodnn':
    ...
    model = RGNNdist2vec(n_input=2,                                 ## Input embedding size (coordinates)
                         ...
                         directed=args.directed                     ## Whether to use directed GNN
                         )
    ...
    model = DualGNN(n_input=2,
                    ...
                    use_l1tilde=False,
                    directed=args.directed)
elif model_class == 'dual_gnn_l1tilde':
    from models.dual_gnn import DualGNN
